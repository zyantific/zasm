...
namespace zasm::tests
{
	...
	INSTRUCTION_TEST(66F20F38F18C1A80000000      , crc32(ecx, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(66F20F38F1CA                , crc32(ecx, dx));
	...
	INSTRUCTION_TEST(660FAF8C1A80000000          , imul(word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(0FAF8C1A80000000            , imul(dword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(0FB48C1A80000000            , lfs(ecx, fword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(480FB48C1A80000000          , lfs(rcx, tbyte_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(0FB58C1A80000000            , lgs(ecx, fword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(0FB28C1A80000000            , lss(ecx, fword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(66F30FBD8C1A80000000        , lzcnt(cx, word_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(66F30FBDCA                  , lzcnt(cx, dx));
	...
	INSTRUCTION_TEST(440F20C0                    , mov(rax, cr8));
	INSTRUCTION_TEST(0F20C0                      , mov(rax, cr0));
	...
	INSTRUCTION_TEST(0F20D1                      , mov(rcx, cr2));
	INSTRUCTION_TEST(668EA41A80000000            , mov(fs, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(0F22CA                      , mov(cr1, rdx));
	...
	INSTRUCTION_TEST(0F23CA                      , mov(dr1, rdx));
	...
	INSTRUCTION_TEST(66638C1A80000000            , movsxd(cx, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(660F1F841180000000          , nop(word_ptr(rcx, rdx, 1, 128)));
	INSTRUCTION_TEST(660F1F9C1180000000          , nop(word_ptr(rcx, rdx, 1, 128), bx));
	INSTRUCTION_TEST(480F1FC1                    , nop(rcx));
	INSTRUCTION_TEST(480F1FD1                    , nop(rcx, rdx));
	INSTRUCTION_TEST(480F1F841180000000          , nop(qword_ptr(rcx, rdx, 1, 128)));
	INSTRUCTION_TEST(480F1F9C1180000000          , nop(qword_ptr(rcx, rdx, 1, 128), rbx));
	INSTRUCTION_TEST(0F1FD1                      , nop(ecx, edx));
	INSTRUCTION_TEST(0F1F841180000000            , nop(dword_ptr(rcx, rdx, 1, 128)));
	INSTRUCTION_TEST(0F1F9C1180000000            , nop(dword_ptr(rcx, rdx, 1, 128), ebx));
	INSTRUCTION_TEST(660F1FC1                    , nop(cx));
	INSTRUCTION_TEST(660F1FD1                    , nop(cx, dx));
	INSTRUCTION_TEST(90                          , nop());
	INSTRUCTION_TEST(0F1FC1                      , nop(ecx));
	...
	INSTRUCTION_TEST(66F30FB8CA                  , popcnt(cx, dx));
	INSTRUCTION_TEST(66F30FB88C1A80000000        , popcnt(cx, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(F600FF                      , test(byte_ptr(rax), Imm(0xFF)));
	...
	INSTRUCTION_TEST(66F30FBCCA                  , tzcnt(cx, dx));
	INSTRUCTION_TEST(66F30FBC8C1A80000000        , tzcnt(cx, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(62D1F70058D8                , vaddsd(xmm3, xmm17, xmm8));
	INSTRUCTION_TEST(62F1F700589A00040000        , vaddsd(xmm3, xmm17, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62F1F700585A7F              , vaddsd(xmm3, xmm17, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62F1F700589AF8FBFFFF        , vaddsd(xmm3, xmm17, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62F1F700585A80              , vaddsd(xmm3, xmm17, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62F1F7005819                , vaddsd(xmm3, xmm17, qword_ptr(rcx)));
	INSTRUCTION_TEST(62B1F700589CF023010000      , vaddsd(xmm3, xmm17, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(C5EB58CB                    , vaddsd(xmm1, xmm2, xmm3));
	INSTRUCTION_TEST(6291EF0058CB                , vaddsd(xmm1, xmm18, xmm27));
	INSTRUCTION_TEST(62F1EF00588A00040000        , vaddsd(xmm1, xmm18, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62F1EF00584A7F              , vaddsd(xmm1, xmm18, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62F1EF00588AF8FBFFFF        , vaddsd(xmm1, xmm18, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62F1EF00584A80              , vaddsd(xmm1, xmm18, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62F1EF005809                , vaddsd(xmm1, xmm18, qword_ptr(rcx)));
	INSTRUCTION_TEST(62B1EF00588CF034120000      , vaddsd(xmm1, xmm18, qword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(C5EB588C2B80000000          , vaddsd(xmm1, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62B1560858FB                , vaddss(xmm7, xmm5, xmm19));
	...
	INSTRUCTION_TEST(62C10E0858CF                , vaddss(xmm17, xmm14, xmm15));
	INSTRUCTION_TEST(C5D258BAFCFDFFFF            , vaddss(xmm7, xmm5, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E10E08584A7F              , vaddss(xmm17, xmm14, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E10E08588AFCFDFFFF        , vaddss(xmm17, xmm14, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E10E08584A80              , vaddss(xmm17, xmm14, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E10E085809                , vaddss(xmm17, xmm14, dword_ptr(rcx)));
	INSTRUCTION_TEST(62A10E08588CF034120000      , vaddss(xmm17, xmm14, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62E10E08588A00020000        , vaddss(xmm17, xmm14, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E27D19CA                  , vbroadcastsd(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D198C1A80000000        , vbroadcastsd(ymm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E279188C1A80000000        , vbroadcastss(xmm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D188C1A80000000        , vbroadcastss(ymm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D18CA                  , vbroadcastss(ymm1, xmm2));
	INSTRUCTION_TEST(C4E27918CA                  , vbroadcastss(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C4E279138C1A80000000        , vcvtph2ps(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27913CA                  , vcvtph2ps(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D13CA                  , vcvtph2ps(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D138C1A80000000        , vcvtph2ps(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C5F95B8C1A80000000          , vcvtps2dq(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FD5BCA                    , vcvtps2dq(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FD5B8C1A80000000          , vcvtps2dq(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5F95BCA                    , vcvtps2dq(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C5FC5A8C1A80000000          , vcvtps2pd(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FC5ACA                    , vcvtps2pd(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C5F85ACA                    , vcvtps2pd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C5F85A8C1A80000000          , vcvtps2pd(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E37D1D9C118000000001      , vcvtps2ph(xmmword_ptr(rcx, rdx, 1, 128), k0, ymm3, Imm(1)));
	INSTRUCTION_TEST(C4E37D1DD101                , vcvtps2ph(xmm1,k0,  ymm2, Imm(1)));
	INSTRUCTION_TEST(C4E3791DD101                , vcvtps2ph(xmm1,k0,  xmm2, Imm(1)));
	INSTRUCTION_TEST(C4E3791D9C118000000001      , vcvtps2ph(qword_ptr(rcx, rdx, 1, 128), k0, xmm3, Imm(1)));
	...
	INSTRUCTION_TEST(62C1B7085ACC                , vcvtsd2ss(xmm17, xmm9, xmm12));
	INSTRUCTION_TEST(62E1B7085A8A00040000        , vcvtsd2ss(xmm17, xmm9, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62E1B7085A4A7F              , vcvtsd2ss(xmm17, xmm9, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62E1B7085A8AF8FBFFFF        , vcvtsd2ss(xmm17, xmm9, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(C5EB5A8C2B80000000          , vcvtsd2ss(xmm1, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62E1B7085A09                , vcvtsd2ss(xmm17, xmm9, qword_ptr(rcx)));
	INSTRUCTION_TEST(62A1B7085A8CF023010000      , vcvtsd2ss(xmm17, xmm9, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(C5EB5ACB                    , vcvtsd2ss(xmm1, xmm2, xmm3));
	INSTRUCTION_TEST(62E1B7085A4A80              , vcvtsd2ss(xmm17, xmm9, qword_ptr(rdx, -1024)));
	...
	INSTRUCTION_TEST(62614E085AA2FCFDFFFF        , vcvtss2sd(xmm28, xmm6, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62614E085AA200020000        , vcvtss2sd(xmm28, xmm6, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62614E085A627F              , vcvtss2sd(xmm28, xmm6, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62614E085A6280              , vcvtss2sd(xmm28, xmm6, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62614E085AE6                , vcvtss2sd(xmm28, xmm6, xmm6));
	INSTRUCTION_TEST(62214E085AA4F023010000      , vcvtss2sd(xmm28, xmm6, dword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(62614E085A21                , vcvtss2sd(xmm28, xmm6, dword_ptr(rcx)));
	...
	INSTRUCTION_TEST(C5FDE68C1A80000000          , vcvttpd2dq(xmm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FDE6CA                    , vcvttpd2dq(xmm1, k0, ymm2));
	INSTRUCTION_TEST(C5F9E68C1A80000000          , vcvttpd2dq(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5F9E6CA                    , vcvttpd2dq(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C5FE5B8C1A80000000          , vcvttps2dq(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FE5BCA                    , vcvttps2dq(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FA5B8C1A80000000          , vcvttps2dq(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FA5BCA                    , vcvttps2dq(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C5E95E8C2B80000000          , vdivpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED5ECB                    , vdivpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED5E8C2B80000000          , vdivpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E95ECB                    , vdivpd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EC5E8C2B80000000          , vdivps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC5ECB                    , vdivps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E85E8C2B80000000          , vdivps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E85ECB                    , vdivps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(62E144405E7A80              , vdivps(zmm23, k0, zmm23, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(6231DF085EFE                , vdivsd(xmm15, xmm4, xmm22));
	INSTRUCTION_TEST(626197085EAA00040000        , vdivsd(xmm29, xmm13, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(626197085E6A7F              , vdivsd(xmm29, xmm13, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(626197085E6A80              , vdivsd(xmm29, xmm13, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(626197085E29                , vdivsd(xmm29, xmm13, qword_ptr(rcx)));
	INSTRUCTION_TEST(622197085EACF023010000      , vdivsd(xmm29, xmm13, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(C55B5EBA00040000            , vdivsd(xmm15, xmm4, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(622197085EEE                , vdivsd(xmm29, xmm13, xmm22));
	...
	INSTRUCTION_TEST(626197085EAAF8FBFFFF        , vdivsd(xmm29, xmm13, qword_ptr(rdx, -1032)));
	...
	INSTRUCTION_TEST(62216E085EDC                , vdivss(xmm27, xmm2, xmm20));
	INSTRUCTION_TEST(62616E085E9A00020000        , vdivss(xmm27, xmm2, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62616E085E9AFCFDFFFF        , vdivss(xmm27, xmm2, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62616E085E5A80              , vdivss(xmm27, xmm2, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62616E085E19                , vdivss(xmm27, xmm2, dword_ptr(rcx)));
	INSTRUCTION_TEST(62216E085E9CF034120000      , vdivss(xmm27, xmm2, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62A14E085EE9                , vdivss(xmm21, xmm6, xmm17));
	INSTRUCTION_TEST(62616E085E5A7F              , vdivss(xmm27, xmm2, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E14E085E6A7F              , vdivss(xmm21, xmm6, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E14E085EAAFCFDFFFF        , vdivss(xmm21, xmm6, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E14E085E6A80              , vdivss(xmm21, xmm6, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E14E085E29                , vdivss(xmm21, xmm6, dword_ptr(rcx)));
	INSTRUCTION_TEST(62A14E085EACF023010000      , vdivss(xmm21, xmm6, dword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(62E14E085EAA00020000        , vdivss(xmm21, xmm6, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E2E998CB                  , vfmadd132pd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E9988C2B80000000        , vfmadd132pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED98CB                  , vfmadd132pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2ED988C2B80000000        , vfmadd132pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D988C2B80000000        , vfmadd132ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D98CB                  , vfmadd132ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269988C2B80000000        , vfmadd132ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26998CB                  , vfmadd132ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2E999CB                  , vfmadd132sd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E9998C2B80000000        , vfmadd132sd(xmm1, k0, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(62625D00999200020000        , vfmadd132ss(xmm26, xmm20, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E2EDA88C2B80000000        , vfmadd213pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDA8CB                  , vfmadd213pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9A88C2B80000000        , vfmadd213pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9A8CB                  , vfmadd213pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26DA88C2B80000000        , vfmadd213ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DA8CB                  , vfmadd213ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269A88C2B80000000        , vfmadd213ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269A8CB                  , vfmadd213ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2E9A9CB                  , vfmadd213sd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E9A98C2B80000000        , vfmadd213sd(xmm1, k0, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(6262AD00A98200040000        , vfmadd213sd(xmm24, k0, xmm26, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62224D00A9F0                , vfmadd213ss(xmm30, xmm22, xmm16));
	INSTRUCTION_TEST(62624D00A9B200020000        , vfmadd213ss(xmm30, xmm22, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62624D00A9727F              , vfmadd213ss(xmm30, xmm22, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62624D00A9B2FCFDFFFF        , vfmadd213ss(xmm30, xmm22, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62624D00A97280              , vfmadd213ss(xmm30, xmm22, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62624D00A931                , vfmadd213ss(xmm30, xmm22, dword_ptr(rcx)));
	INSTRUCTION_TEST(62224D00A9B4F023010000      , vfmadd213ss(xmm30, xmm22, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62823500A9D1                , vfmadd213ss(xmm18, xmm25, xmm25));
	INSTRUCTION_TEST(62E23500A9527F              , vfmadd213ss(xmm18, xmm25, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E23500A992FCFDFFFF        , vfmadd213ss(xmm18, xmm25, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E23500A95280              , vfmadd213ss(xmm18, xmm25, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E23500A911                , vfmadd213ss(xmm18, xmm25, dword_ptr(rcx)));
	INSTRUCTION_TEST(62A23500A994F034120000      , vfmadd213ss(xmm18, xmm25, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62E23500A99200020000        , vfmadd213ss(xmm18, xmm25, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E2EDB88C2B80000000        , vfmadd231pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDB8CB                  , vfmadd231pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9B88C2B80000000        , vfmadd231pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9B8CB                  , vfmadd231pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E269B88C2B80000000        , vfmadd231ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DB8CB                  , vfmadd231ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26DB88C2B80000000        , vfmadd231ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269B8CB                  , vfmadd231ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(62220508B9ACF023010000      , vfmadd231ss(xmm29, xmm15, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62620508B9AA00020000        , vfmadd231ss(xmm29, xmm15, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62420508B9EA                , vfmadd231ss(xmm29, xmm15, xmm10));
	INSTRUCTION_TEST(62620508B96A7F              , vfmadd231ss(xmm29, xmm15, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62620508B9AAFCFDFFFF        , vfmadd231ss(xmm29, xmm15, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62620508B96A80              , vfmadd231ss(xmm29, xmm15, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62620508B929                , vfmadd231ss(xmm29, xmm15, dword_ptr(rcx)));
	INSTRUCTION_TEST(62220D08B9D3                , vfmadd231ss(xmm26, xmm14, xmm19));
	INSTRUCTION_TEST(C4E269B9CB                  , vfmadd231ss(xmm1, xmm2, xmm3));
	INSTRUCTION_TEST(62620D08B9527F              , vfmadd231ss(xmm26, xmm14, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62620D08B992FCFDFFFF        , vfmadd231ss(xmm26, xmm14, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62620D08B95280              , vfmadd231ss(xmm26, xmm14, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62620D08B911                , vfmadd231ss(xmm26, xmm14, dword_ptr(rcx)));
	INSTRUCTION_TEST(62220D08B994F034120000      , vfmadd231ss(xmm26, xmm14, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(C4E269B98C2B80000000        , vfmadd231ss(xmm1, xmm2, dword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62620D08B99200020000        , vfmadd231ss(xmm26, xmm14, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(C4E3E969CC30                , vfmaddpd(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3ED69CC30                , vfmaddpd(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3ED68CC30                , vfmaddps(ymm1, ymm2, ymm3, ymm4));
	INSTRUCTION_TEST(C4E3E9688C358000000030      , vfmaddps(xmm1, xmm2, xmm3, xmmword_ptr(rbp, rsi, 1, 128)));
	INSTRUCTION_TEST(C4E3E968CC30                , vfmaddps(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3E96BCC30                , vfmaddsd(xmm1, xmm2, xmm3, xmm4));
	INSTRUCTION_TEST(C4E3E96A8C358000000030      , vfmaddss(xmm1, xmm2, xmm3, dword_ptr(rbp, rsi, 1, 128)));
	INSTRUCTION_TEST(C4E3E96ACC30                , vfmaddss(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E2E996CB                  , vfmaddsub132pd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E9968C2B80000000        , vfmaddsub132pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED96CB                  , vfmaddsub132pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2ED968C2B80000000        , vfmaddsub132pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D968C2B80000000        , vfmaddsub132ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D96CB                  , vfmaddsub132ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269968C2B80000000        , vfmaddsub132ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26996CB                  , vfmaddsub132ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2E9A6CB                  , vfmaddsub213pd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E9A68C2B80000000        , vfmaddsub213pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDA6CB                  , vfmaddsub213pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2EDA68C2B80000000        , vfmaddsub213pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26DA68C2B80000000        , vfmaddsub213ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DA6CB                  , vfmaddsub213ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269A68C2B80000000        , vfmaddsub213ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269A6CB                  , vfmaddsub213ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2EDB68C2B80000000        , vfmaddsub231pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDB6CB                  , vfmaddsub231pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9B68C2B80000000        , vfmaddsub231pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9B6CB                  , vfmaddsub231pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26DB68C2B80000000        , vfmaddsub231ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DB6CB                  , vfmaddsub231ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269B68C2B80000000        , vfmaddsub231ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269B6CB                  , vfmaddsub231ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E3ED5DCC30                , vfmaddsubpd(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3E95DCC30                , vfmaddsubpd(xmm1, xmm2, xmm3, xmm4));
	INSTRUCTION_TEST(C4E3E95CCC30                , vfmaddsubps(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3ED5CCC30                , vfmaddsubps(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E2E99ACB                  , vfmsub132pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2ED9A8C2B80000000        , vfmsub132pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED9ACB                  , vfmsub132pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E99A8C2B80000000        , vfmsub132pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2699A8C2B80000000        , vfmsub132ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D9ACB                  , vfmsub132ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26D9A8C2B80000000        , vfmsub132ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2699ACB                  , vfmsub132ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C462B99BA2F8030000          , vfmsub132sd(xmm12, k0, xmm8, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(C462B99BA2F8FBFFFF          , vfmsub132sd(xmm12, k0, xmm8, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(C462B99BA200FCFFFF          , vfmsub132sd(xmm12, k0, xmm8, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(C462B99B21                  , vfmsub132sd(xmm12, k0, xmm8, qword_ptr(rcx)));
	INSTRUCTION_TEST(C422B99BA4F023010000        , vfmsub132sd(xmm12, k0, xmm8, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(C4E2E99BCB                  , vfmsub132sd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E99B8C2B80000000        , vfmsub132sd(xmm1, k0, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C462B99BA200040000          , vfmsub132sd(xmm12, k0, xmm8, qword_ptr(rdx, 1024)));
	...
	INSTRUCTION_TEST(C4E2699BCB                  , vfmsub132ss(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2699B8C2B80000000        , vfmsub132ss(xmm1, k0, xmm2, dword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2E9AACB                  , vfmsub213pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2EDAA8C2B80000000        , vfmsub213pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDAACB                  , vfmsub213pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9AA8C2B80000000        , vfmsub213pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E269AACB                  , vfmsub213ps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E26DAACB                  , vfmsub213ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(62E24D40AA7280              , vfmsub213ps(zmm22, k0, zmm22, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(C4E26DAA8C2B80000000        , vfmsub213ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269AA8C2B80000000        , vfmsub213ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4A2B9ABB4F023010000        , vfmsub213sd(xmm6, k0, xmm8, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(C4E2B9ABB200040000          , vfmsub213sd(xmm6, k0, xmm8, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(C4E2B9ABB2F8030000          , vfmsub213sd(xmm6, k0, xmm8, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(C4E2B9ABB2F8FBFFFF          , vfmsub213sd(xmm6, k0, xmm8, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(C4E2B9ABB200FCFFFF          , vfmsub213sd(xmm6, k0, xmm8, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(C4E2B9AB31                  , vfmsub213sd(xmm6, k0, xmm8, qword_ptr(rcx)));
	INSTRUCTION_TEST(6232ED00ABE4                , vfmsub213sd(xmm12, k0, xmm18, xmm20));
	INSTRUCTION_TEST(C4C2B9ABF4                  , vfmsub213sd(xmm6, k0, xmm8, xmm12));
	...
	INSTRUCTION_TEST(C4E2E9ABCB                  , vfmsub213sd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E9AB8C2B80000000        , vfmsub213sd(xmm1, k0, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4C271ABD1                  , vfmsub213ss(xmm2, k0, xmm1, xmm9));
	INSTRUCTION_TEST(C4E271AB92FC010000          , vfmsub213ss(xmm2, k0, xmm1, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(C4E271AB92FCFDFFFF          , vfmsub213ss(xmm2, k0, xmm1, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(C4E271AB9200FEFFFF          , vfmsub213ss(xmm2, k0, xmm1, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(C4E271AB11                  , vfmsub213ss(xmm2, k0, xmm1, dword_ptr(rcx)));
	INSTRUCTION_TEST(C4A271AB94F034120000        , vfmsub213ss(xmm2, k0, xmm1, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(C4E269ABCB                  , vfmsub213ss(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E269AB8C2B80000000        , vfmsub213ss(xmm1, k0, xmm2, dword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E271AB9200020000          , vfmsub213ss(xmm2, k0, xmm1, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E2E9BACB                  , vfmsub231pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2EDBA8C2B80000000        , vfmsub231pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDBACB                  , vfmsub231pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9BA8C2B80000000        , vfmsub231pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E269BA8C2B80000000        , vfmsub231ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DBACB                  , vfmsub231ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26DBA8C2B80000000        , vfmsub231ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269BACB                  , vfmsub231ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(62626508BBED                , vfmsub231ss(xmm29, xmm3, xmm5));
	INSTRUCTION_TEST(62626508BBAA00020000        , vfmsub231ss(xmm29, xmm3, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62626508BB6A7F              , vfmsub231ss(xmm29, xmm3, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62626508BBAAFCFDFFFF        , vfmsub231ss(xmm29, xmm3, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62626508BB6A80              , vfmsub231ss(xmm29, xmm3, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62626508BB29                , vfmsub231ss(xmm29, xmm3, dword_ptr(rcx)));
	INSTRUCTION_TEST(62226508BBACF023010000      , vfmsub231ss(xmm29, xmm3, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62A26D00BBD2                , vfmsub231ss(xmm18, xmm18, xmm18));
	INSTRUCTION_TEST(62E26D00BB527F              , vfmsub231ss(xmm18, xmm18, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E26D00BB92FCFDFFFF        , vfmsub231ss(xmm18, xmm18, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E26D00BB5280              , vfmsub231ss(xmm18, xmm18, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E26D00BB11                , vfmsub231ss(xmm18, xmm18, dword_ptr(rcx)));
	INSTRUCTION_TEST(62A26D00BB94F034120000      , vfmsub231ss(xmm18, xmm18, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62E26D00BB9200020000        , vfmsub231ss(xmm18, xmm18, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E2E9978C2B80000000        , vfmsubadd132pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED97CB                  , vfmsubadd132pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2ED978C2B80000000        , vfmsubadd132pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F2ED4897CB                , vfmsubadd132pd(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C4E2E997CB                  , vfmsubadd132pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D978C2B80000000        , vfmsubadd132ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D97CB                  , vfmsubadd132ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269978C2B80000000        , vfmsubadd132ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26997CB                  , vfmsubadd132ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2E9A78C2B80000000        , vfmsubadd213pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDA7CB                  , vfmsubadd213pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2EDA78C2B80000000        , vfmsubadd213pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9A7CB                  , vfmsubadd213pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E269A7CB                  , vfmsubadd213ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26DA78C2B80000000        , vfmsubadd213ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DA7CB                  , vfmsubadd213ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269A78C2B80000000        , vfmsubadd213ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2EDB78C2B80000000        , vfmsubadd231pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDB7CB                  , vfmsubadd231pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9B78C2B80000000        , vfmsubadd231pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9B7CB                  , vfmsubadd231pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26DB78C2B80000000        , vfmsubadd231ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DB7CB                  , vfmsubadd231ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269B78C2B80000000        , vfmsubadd231ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269B7CB                  , vfmsubadd231ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E3ED5FCC30                , vfmsubaddpd(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3E95FCC30                , vfmsubaddpd(xmm1, xmm2, xmm3, xmm4));
	INSTRUCTION_TEST(C4E3E95ECC30                , vfmsubaddps(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3ED5ECC30                , vfmsubaddps(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3E96DCC30                , vfmsubpd(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3ED6DCC30                , vfmsubpd(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3ED6CCC30                , vfmsubps(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3E96CCC30                , vfmsubps(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3E96FCC30                , vfmsubsd(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3E96ECC30                , vfmsubss(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E2E99CCB                  , vfnmadd132pd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E99C8C2B80000000        , vfnmadd132pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED9CCB                  , vfnmadd132pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2ED9C8C2B80000000        , vfnmadd132pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2699CCB                  , vfnmadd132ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D9C8C2B80000000        , vfnmadd132ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D9CCB                  , vfnmadd132ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2699C8C2B80000000        , vfnmadd132ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62E265489C4A80              , vfnmadd132ps(zmm17, k0, zmm3, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(62F2BD009D11                , vfnmadd132sd(xmm2, xmm24, qword_ptr(rcx)));
	INSTRUCTION_TEST(62F2BD009D5280              , vfnmadd132sd(xmm2, xmm24, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62F2BD009D92F8FBFFFF        , vfnmadd132sd(xmm2, xmm24, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62B2BD009D94F034120000      , vfnmadd132sd(xmm2, xmm24, qword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62F2BD009D9200040000        , vfnmadd132sd(xmm2, xmm24, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62F2BD009DD1                , vfnmadd132sd(xmm2, xmm24, xmm1));
	INSTRUCTION_TEST(62F2BD009D527F              , vfnmadd132sd(xmm2, xmm24, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62C2E5089DDB                , vfnmadd132sd(xmm19, xmm3, xmm11));
	INSTRUCTION_TEST(62E2E5089D9AF8FBFFFF        , vfnmadd132sd(xmm19, xmm3, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62E2E5089D5A7F              , vfnmadd132sd(xmm19, xmm3, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62E2E5089D5A80              , vfnmadd132sd(xmm19, xmm3, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62E2E5089D19                , vfnmadd132sd(xmm19, xmm3, qword_ptr(rcx)));
	INSTRUCTION_TEST(62A2E5089D9CF023010000      , vfnmadd132sd(xmm19, xmm3, qword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(62E2E5089D9A00040000        , vfnmadd132sd(xmm19, xmm3, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(622275089DCF                , vfnmadd132ss(xmm25, xmm1, xmm23));
	INSTRUCTION_TEST(626275089D8A00020000        , vfnmadd132ss(xmm25, xmm1, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(626275089D4A7F              , vfnmadd132ss(xmm25, xmm1, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(626275089D8AFCFDFFFF        , vfnmadd132ss(xmm25, xmm1, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(626275089D4A80              , vfnmadd132ss(xmm25, xmm1, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(626275089D09                , vfnmadd132ss(xmm25, xmm1, dword_ptr(rcx)));
	INSTRUCTION_TEST(622275089D8CF023010000      , vfnmadd132ss(xmm25, xmm1, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(625265009DED                , vfnmadd132ss(xmm13, xmm19, xmm13));
	INSTRUCTION_TEST(627265009D6A7F              , vfnmadd132ss(xmm13, xmm19, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(627265009DAAFCFDFFFF        , vfnmadd132ss(xmm13, xmm19, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(627265009D6A80              , vfnmadd132ss(xmm13, xmm19, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(627265009D29                , vfnmadd132ss(xmm13, xmm19, dword_ptr(rcx)));
	...
	INSTRUCTION_TEST(627265009DAA00020000        , vfnmadd132ss(xmm13, xmm19, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E2E9ACCB                  , vfnmadd213pd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2E9AC8C2B80000000        , vfnmadd213pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDACCB                  , vfnmadd213pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2EDAC8C2B80000000        , vfnmadd213pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26DAC8C2B80000000        , vfnmadd213ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DACCB                  , vfnmadd213ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269AC8C2B80000000        , vfnmadd213ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269ACCB                  , vfnmadd213ps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(62725D48AC5A80              , vfnmadd213ps(zmm11, k0, zmm4, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(62228D08ADB4F034120000      , vfnmadd213sd(xmm30, xmm14, qword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62628D08ADB200040000        , vfnmadd213sd(xmm30, xmm14, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62628D08AD727F              , vfnmadd213sd(xmm30, xmm14, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62628D08ADB2F8FBFFFF        , vfnmadd213sd(xmm30, xmm14, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62628D08AD7280              , vfnmadd213sd(xmm30, xmm14, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62628D08AD31                , vfnmadd213sd(xmm30, xmm14, qword_ptr(rcx)));
	INSTRUCTION_TEST(6272A500ADEA                , vfnmadd213sd(xmm13, xmm27, xmm2));
	INSTRUCTION_TEST(62428D08ADF3                , vfnmadd213sd(xmm30, xmm14, xmm11));
	INSTRUCTION_TEST(6272A500AD6A7F              , vfnmadd213sd(xmm13, xmm27, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(6272A500ADAAF8FBFFFF        , vfnmadd213sd(xmm13, xmm27, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(6272A500AD6A80              , vfnmadd213sd(xmm13, xmm27, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(6272A500AD29                , vfnmadd213sd(xmm13, xmm27, qword_ptr(rcx)));
	INSTRUCTION_TEST(6232A500ADACF023010000      , vfnmadd213sd(xmm13, xmm27, qword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(6272A500ADAA00040000        , vfnmadd213sd(xmm13, xmm27, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62024508ADEC                , vfnmadd213ss(xmm29, xmm7, xmm28));
	INSTRUCTION_TEST(62624508ADAA00020000        , vfnmadd213ss(xmm29, xmm7, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62624508AD6A7F              , vfnmadd213ss(xmm29, xmm7, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62624508ADAAFCFDFFFF        , vfnmadd213ss(xmm29, xmm7, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62624508AD6A80              , vfnmadd213ss(xmm29, xmm7, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62624508AD29                , vfnmadd213ss(xmm29, xmm7, dword_ptr(rcx)));
	INSTRUCTION_TEST(62224508ADACF023010000      , vfnmadd213ss(xmm29, xmm7, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62226508ADE4                , vfnmadd213ss(xmm28, xmm3, xmm20));
	INSTRUCTION_TEST(62626508AD627F              , vfnmadd213ss(xmm28, xmm3, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62626508ADA2FCFDFFFF        , vfnmadd213ss(xmm28, xmm3, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62626508AD6280              , vfnmadd213ss(xmm28, xmm3, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62626508AD21                , vfnmadd213ss(xmm28, xmm3, dword_ptr(rcx)));
	INSTRUCTION_TEST(62226508ADA4F034120000      , vfnmadd213ss(xmm28, xmm3, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62626508ADA200020000        , vfnmadd213ss(xmm28, xmm3, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E2EDBCCB                  , vfnmadd231pd(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C4E2EDBC8C2B80000000        , vfnmadd231pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9BC8C2B80000000        , vfnmadd231pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9BCCB                  , vfnmadd231pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E269BCCB                  , vfnmadd231ps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E269BC8C2B80000000        , vfnmadd231ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DBCCB                  , vfnmadd231ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26DBC8C2B80000000        , vfnmadd231ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(62B2A508BDF2                , vfnmadd231sd(xmm6, xmm11, xmm18));
	...
	INSTRUCTION_TEST(62226D08BDD9                , vfnmadd231ss(xmm27, xmm2, xmm17));
	INSTRUCTION_TEST(62626D08BD9A00020000        , vfnmadd231ss(xmm27, xmm2, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62626D08BD5A7F              , vfnmadd231ss(xmm27, xmm2, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62626D08BD9AFCFDFFFF        , vfnmadd231ss(xmm27, xmm2, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62626D08BD5A80              , vfnmadd231ss(xmm27, xmm2, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62626D08BD19                , vfnmadd231ss(xmm27, xmm2, dword_ptr(rcx)));
	INSTRUCTION_TEST(62226D08BD9CF023010000      , vfnmadd231ss(xmm27, xmm2, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62027D00BDC9                , vfnmadd231ss(xmm25, xmm16, xmm25));
	INSTRUCTION_TEST(62627D00BD4A80              , vfnmadd231ss(xmm25, xmm16, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62627D00BD4A7F              , vfnmadd231ss(xmm25, xmm16, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62627D00BD8AFCFDFFFF        , vfnmadd231ss(xmm25, xmm16, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62627D00BD09                , vfnmadd231ss(xmm25, xmm16, dword_ptr(rcx)));
	INSTRUCTION_TEST(62227D00BD8CF034120000      , vfnmadd231ss(xmm25, xmm16, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62627D00BD8A00020000        , vfnmadd231ss(xmm25, xmm16, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(C4E3ED798C358000000030      , vfnmaddpd(ymm1, ymm2, ymm3, ymmword_ptr(rbp, rsi, 1, 128)));
	INSTRUCTION_TEST(C4E3ED79CC30                , vfnmaddpd(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3E979CC30                , vfnmaddpd(xmm1, xmm2, xmm3, xmm4));
	INSTRUCTION_TEST(C4E369798C2B8000000060      , vfnmaddpd(xmm1, xmm2, xmmword_ptr(rbx, rbp, 1, 128), xmm6));
	INSTRUCTION_TEST(C4E3E978CC30                , vfnmaddps(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3ED78CC30                , vfnmaddps(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3E97BCC30                , vfnmaddsd(xmm1, xmm2, xmm3, xmm4));
	INSTRUCTION_TEST(C4E3E97ACC30                , vfnmaddss(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E2ED9E8C2B80000000        , vfnmsub132pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED9ECB                  , vfnmsub132pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E99E8C2B80000000        , vfnmsub132pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E99ECB                  , vfnmsub132pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D9E8C2B80000000        , vfnmsub132ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D9ECB                  , vfnmsub132ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2699E8C2B80000000        , vfnmsub132ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2699ECB                  , vfnmsub132ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(62B2BD089FDB                , vfnmsub132sd(xmm3, xmm8, xmm19));
	...
	INSTRUCTION_TEST(6242A5089FD5                , vfnmsub132sd(xmm26, xmm11, xmm13));
	INSTRUCTION_TEST(6262A5089F527F              , vfnmsub132sd(xmm26, xmm11, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(6262A5089F92F8FBFFFF        , vfnmsub132sd(xmm26, xmm11, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(6262A5089F5280              , vfnmsub132sd(xmm26, xmm11, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(6262A5089F11                , vfnmsub132sd(xmm26, xmm11, qword_ptr(rcx)));
	INSTRUCTION_TEST(6222A5089F94F023010000      , vfnmsub132sd(xmm26, xmm11, qword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(6262A5089F9200040000        , vfnmsub132sd(xmm26, xmm11, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62824D009FF8                , vfnmsub132ss(xmm23, xmm22, xmm24));
	INSTRUCTION_TEST(62E24D009FBA00020000        , vfnmsub132ss(xmm23, xmm22, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62E24D009F7A7F              , vfnmsub132ss(xmm23, xmm22, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E24D009FBAFCFDFFFF        , vfnmsub132ss(xmm23, xmm22, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E24D009F7A80              , vfnmsub132ss(xmm23, xmm22, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E24D009F39                , vfnmsub132ss(xmm23, xmm22, dword_ptr(rcx)));
	INSTRUCTION_TEST(62E275009FDE                , vfnmsub132ss(xmm19, xmm17, xmm6));
	INSTRUCTION_TEST(62A24D009FBCF023010000      , vfnmsub132ss(xmm23, xmm22, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62E275009F5A7F              , vfnmsub132ss(xmm19, xmm17, dword_ptr(rdx, 508)));
	...
	INSTRUCTION_TEST(62A275009F9CF034120000      , vfnmsub132ss(xmm19, xmm17, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62E275009F9A00020000        , vfnmsub132ss(xmm19, xmm17, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62E275009F5A80              , vfnmsub132ss(xmm19, xmm17, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E275009F9AFCFDFFFF        , vfnmsub132ss(xmm19, xmm17, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E275009F19                , vfnmsub132ss(xmm19, xmm17, dword_ptr(rcx)));
	...
	INSTRUCTION_TEST(C4E2EDAE8C2B80000000        , vfnmsub213pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDAECB                  , vfnmsub213pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9AE8C2B80000000        , vfnmsub213pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9AECB                  , vfnmsub213pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E269AE8C2B80000000        , vfnmsub213ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DAECB                  , vfnmsub213ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26DAE8C2B80000000        , vfnmsub213ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269AECB                  , vfnmsub213ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(6222C500AFACF023010000      , vfnmsub213sd(xmm29, xmm23, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(6202C500AFEC                , vfnmsub213sd(xmm29, xmm23, xmm28));
	INSTRUCTION_TEST(6262C500AFAA00040000        , vfnmsub213sd(xmm29, xmm23, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(6262C500AF6A7F              , vfnmsub213sd(xmm29, xmm23, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(6262C500AFAAF8FBFFFF        , vfnmsub213sd(xmm29, xmm23, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(6262C500AF6A80              , vfnmsub213sd(xmm29, xmm23, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(6262C500AF29                , vfnmsub213sd(xmm29, xmm23, qword_ptr(rcx)));
	INSTRUCTION_TEST(6222BD08AFCF                , vfnmsub213sd(xmm25, xmm8, xmm23));
	INSTRUCTION_TEST(6262BD08AF4A7F              , vfnmsub213sd(xmm25, xmm8, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(6262BD08AF8AF8FBFFFF        , vfnmsub213sd(xmm25, xmm8, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(6262BD08AF4A80              , vfnmsub213sd(xmm25, xmm8, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(6262BD08AF09                , vfnmsub213sd(xmm25, xmm8, qword_ptr(rcx)));
	INSTRUCTION_TEST(6222BD08AF8CF034120000      , vfnmsub213sd(xmm25, xmm8, qword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(6262BD08AF8A00040000        , vfnmsub213sd(xmm25, xmm8, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62625D00AF01                , vfnmsub213ss(xmm24, xmm20, dword_ptr(rcx)));
	INSTRUCTION_TEST(62425D00AFC7                , vfnmsub213ss(xmm24, xmm20, xmm15));
	INSTRUCTION_TEST(62625D00AF8200020000        , vfnmsub213ss(xmm24, xmm20, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62625D00AF427F              , vfnmsub213ss(xmm24, xmm20, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62625D00AF82FCFDFFFF        , vfnmsub213ss(xmm24, xmm20, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62625D00AF4280              , vfnmsub213ss(xmm24, xmm20, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62521D00AFF4                , vfnmsub213ss(xmm14, xmm28, xmm12));
	INSTRUCTION_TEST(62225D00AF84F034120000      , vfnmsub213ss(xmm24, xmm20, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62721D00AF727F              , vfnmsub213ss(xmm14, xmm28, dword_ptr(rdx, 508)));
	...
	INSTRUCTION_TEST(62321D00AFB4F023010000      , vfnmsub213ss(xmm14, xmm28, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62721D00AFB200020000        , vfnmsub213ss(xmm14, xmm28, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62721D00AF7280              , vfnmsub213ss(xmm14, xmm28, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62721D00AFB2FCFDFFFF        , vfnmsub213ss(xmm14, xmm28, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62721D00AF31                , vfnmsub213ss(xmm14, xmm28, dword_ptr(rcx)));
	...
	INSTRUCTION_TEST(C4E2EDBE8C2B80000000        , vfnmsub231pd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2EDBECB                  , vfnmsub231pd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9BE8C2B80000000        , vfnmsub231pd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E9BECB                  , vfnmsub231pd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E269BE8C2B80000000        , vfnmsub231ps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26DBECB                  , vfnmsub231ps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26DBE8C2B80000000        , vfnmsub231ps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269BECB                  , vfnmsub231ps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(62B2DD00BFB4F023010000      , vfnmsub231sd(xmm6, xmm20, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62D2DD00BFF6                , vfnmsub231sd(xmm6, xmm20, xmm14));
	INSTRUCTION_TEST(62F2DD00BFB200040000        , vfnmsub231sd(xmm6, xmm20, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62F2DD00BF727F              , vfnmsub231sd(xmm6, xmm20, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62F2DD00BF7280              , vfnmsub231sd(xmm6, xmm20, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62F2DD00BF31                , vfnmsub231sd(xmm6, xmm20, qword_ptr(rcx)));
	INSTRUCTION_TEST(6282CD08BFDA                , vfnmsub231sd(xmm19, xmm6, xmm26));
	INSTRUCTION_TEST(62F2DD00BFB2F8FBFFFF        , vfnmsub231sd(xmm6, xmm20, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62E2CD08BF5A7F              , vfnmsub231sd(xmm19, xmm6, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62E2CD08BF9AF8FBFFFF        , vfnmsub231sd(xmm19, xmm6, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62E2CD08BF5A80              , vfnmsub231sd(xmm19, xmm6, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62E2CD08BF19                , vfnmsub231sd(xmm19, xmm6, qword_ptr(rcx)));
	INSTRUCTION_TEST(62A2CD08BF9CF034120000      , vfnmsub231sd(xmm19, xmm6, qword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62E2CD08BF9A00040000        , vfnmsub231sd(xmm19, xmm6, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62421508BFD2                , vfnmsub231ss(xmm26, xmm13, xmm10));
	INSTRUCTION_TEST(62621508BF9200020000        , vfnmsub231ss(xmm26, xmm13, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62621508BF527F              , vfnmsub231ss(xmm26, xmm13, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62621508BF92FCFDFFFF        , vfnmsub231ss(xmm26, xmm13, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62621508BF5280              , vfnmsub231ss(xmm26, xmm13, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62621508BF11                , vfnmsub231ss(xmm26, xmm13, dword_ptr(rcx)));
	INSTRUCTION_TEST(62221508BF94F023010000      , vfnmsub231ss(xmm26, xmm13, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62726D00BFE9                , vfnmsub231ss(xmm13, xmm18, xmm1));
	INSTRUCTION_TEST(62726D00BFAAFCFDFFFF        , vfnmsub231ss(xmm13, xmm18, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62726D00BF6A7F              , vfnmsub231ss(xmm13, xmm18, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62726D00BF6A80              , vfnmsub231ss(xmm13, xmm18, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62726D00BF29                , vfnmsub231ss(xmm13, xmm18, dword_ptr(rcx)));
	INSTRUCTION_TEST(62326D00BFACF034120000      , vfnmsub231ss(xmm13, xmm18, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62726D00BFAA00020000        , vfnmsub231ss(xmm13, xmm18, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C4E3ED7CCC30                , vfnmsubps(ymm1, ymm2, ymm3, ymm4));
	...
	INSTRUCTION_TEST(C4E3E97FCC30                , vfnmsubsd(xmm1, xmm2, xmm3, xmm4));
	INSTRUCTION_TEST(C4E3E97ECC30                , vfnmsubss(xmm1, xmm2, xmm3, xmm4));
	...
	INSTRUCTION_TEST(C4E3E9CFCB01                , vgf2p8affineinvqb(xmm1, k0, xmm2, xmm3, Imm(1)));
	INSTRUCTION_TEST(C4E3EDCFCB01                , vgf2p8affineinvqb(ymm1, k0, ymm2, ymm3, Imm(1)));
	INSTRUCTION_TEST(C4E3E9CF8C2B8000000001      , vgf2p8affineinvqb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C4E3EDCF8C2B8000000001      , vgf2p8affineinvqb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C4E3E9CECB01                , vgf2p8affineqb(xmm1, k0, xmm2, xmm3, Imm(1)));
	INSTRUCTION_TEST(C4E3EDCECB01                , vgf2p8affineqb(ymm1, k0, ymm2, ymm3, Imm(1)));
	INSTRUCTION_TEST(C4E3E9CE8C2B8000000001      , vgf2p8affineqb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C4E3EDCE8C2B8000000001      , vgf2p8affineqb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C4E26DCF8C2B80000000        , vgf2p8mulb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F26D48CF4C1101            , vgf2p8mulb(zmm1, k0, zmm2, zmmword_ptr(rcx, rdx, 1, 64)));
	INSTRUCTION_TEST(C4E269CF8C2B80000000        , vgf2p8mulb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E269CFCB                  , vgf2p8mulb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E26DCFCB                  , vgf2p8mulb(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C5E95F8C2B80000000          , vmaxpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED5FCB                    , vmaxpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED5F8C2B80000000          , vmaxpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62619D405F7280              , vmaxpd(zmm30, k0, zmm28, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(C5E95FCB                    , vmaxpd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5E85FCB                    , vmaxps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EC5F8C2B80000000          , vmaxps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC5FCB                    , vmaxps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E85F8C2B80000000          , vmaxps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62E13C405F4A80              , vmaxps(zmm17, k0, zmm24, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(62E1D7005F39                , vmaxsd(xmm23, xmm21, qword_ptr(rcx)));
	INSTRUCTION_TEST(62E1D7005F7A80              , vmaxsd(xmm23, xmm21, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62E1D7005FBAF8FBFFFF        , vmaxsd(xmm23, xmm21, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62A1D7005FBCF034120000      , vmaxsd(xmm23, xmm21, qword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62E1D7005FBA00040000        , vmaxsd(xmm23, xmm21, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62A1D7005FF8                , vmaxsd(xmm23, xmm21, xmm16));
	INSTRUCTION_TEST(62E1D7005F7A7F              , vmaxsd(xmm23, xmm21, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(6281E7005FE1                , vmaxsd(xmm20, xmm19, xmm25));
	INSTRUCTION_TEST(62E1E7005F627F              , vmaxsd(xmm20, xmm19, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62E1E7005FA2F8FBFFFF        , vmaxsd(xmm20, xmm19, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62E1E7005F6280              , vmaxsd(xmm20, xmm19, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62E1E7005F21                , vmaxsd(xmm20, xmm19, qword_ptr(rcx)));
	INSTRUCTION_TEST(62A1E7005FA4F023010000      , vmaxsd(xmm20, xmm19, qword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(62E1E7005FA200040000        , vmaxsd(xmm20, xmm19, qword_ptr(rdx, 1024)));
	...
	INSTRUCTION_TEST(62A176005FF0                , vmaxss(xmm22, xmm17, xmm16));
	INSTRUCTION_TEST(62E176005FB200020000        , vmaxss(xmm22, xmm17, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62E176005F727F              , vmaxss(xmm22, xmm17, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E176005FB2FCFDFFFF        , vmaxss(xmm22, xmm17, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E176005F7280              , vmaxss(xmm22, xmm17, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E176005F31                , vmaxss(xmm22, xmm17, dword_ptr(rcx)));
	INSTRUCTION_TEST(62A176005FB4F034120000      , vmaxss(xmm22, xmm17, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(C5E95D8C2B80000000          , vminpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED5DCB                    , vminpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED5D8C2B80000000          , vminpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1ED485DCB                , vminpd(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C5E95DCB                    , vminpd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EC5D8C2B80000000          , vminps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC5DCB                    , vminps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E85D8C2B80000000          , vminps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E85DCB                    , vminps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(62F10C485D5A80              , vminps(zmm3, k0, zmm14, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(62B1B7005DACF023010000      , vminsd(xmm5, xmm25, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62F1B7005DAA00040000        , vminsd(xmm5, xmm25, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62F1B7005D6A7F              , vminsd(xmm5, xmm25, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62F1B7005DAAF8FBFFFF        , vminsd(xmm5, xmm25, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62F1B7005D6A80              , vminsd(xmm5, xmm25, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(6291B7005DEA                , vminsd(xmm5, xmm25, xmm26));
	INSTRUCTION_TEST(6211F7085DD4                , vminsd(xmm10, xmm1, xmm28));
	INSTRUCTION_TEST(62F1B7005D29                , vminsd(xmm5, xmm25, qword_ptr(rcx)));
	...
	INSTRUCTION_TEST(624156085DE0                , vminss(xmm28, xmm5, xmm8));
	INSTRUCTION_TEST(626156085DA200020000        , vminss(xmm28, xmm5, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(626156085DA2FCFDFFFF        , vminss(xmm28, xmm5, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(626156085D6280              , vminss(xmm28, xmm5, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(626156085D21                , vminss(xmm28, xmm5, dword_ptr(rcx)));
	INSTRUCTION_TEST(622156085DA4F034120000      , vminss(xmm28, xmm5, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(623176005DD3                , vminss(xmm10, xmm17, xmm19));
	INSTRUCTION_TEST(626156085D627F              , vminss(xmm28, xmm5, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(627176005D527F              , vminss(xmm10, xmm17, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(627176005D92FCFDFFFF        , vminss(xmm10, xmm17, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(627176005D5280              , vminss(xmm10, xmm17, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(627176005D11                , vminss(xmm10, xmm17, dword_ptr(rcx)));
	INSTRUCTION_TEST(623176005D94F023010000      , vminss(xmm10, xmm17, dword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(627176005D9200020000        , vminss(xmm10, xmm17, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C5F9288C1A80000000          , vmovapd(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5F9299C1180000000          , vmovapd(xmmword_ptr(rcx, rdx, 1, 128), k0, xmm3));
	INSTRUCTION_TEST(C5FD28CA                    , vmovapd(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FD288C1A80000000          , vmovapd(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FD299C1180000000          , vmovapd(ymmword_ptr(rcx, rdx, 1, 128), k0, ymm3));
	...
	INSTRUCTION_TEST(C5F928CA                    , vmovapd(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C5FC299C1180000000          , vmovaps(ymmword_ptr(rcx, rdx, 1, 128), k0, ymm3));
	INSTRUCTION_TEST(C5F828CA                    , vmovaps(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C5F8288C1A80000000          , vmovaps(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5F8299C1180000000          , vmovaps(xmmword_ptr(rcx, rdx, 1, 128), k0, xmm3));
	INSTRUCTION_TEST(C5FC28CA                    , vmovaps(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FC288C1A80000000          , vmovaps(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C5FF128C1A80000000          , vmovddup(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FB12CA                    , vmovddup(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C5FB128C1A80000000          , vmovddup(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(62F1FF48128AC0DFFFFF        , vmovddup(zmm1, k0, zmmword_ptr(rdx, -8256)));
	INSTRUCTION_TEST(C5FF12CA                    , vmovddup(ymm1, k0, ymm2));
	...
	INSTRUCTION_TEST(6221E70810DB                , vmovsd(xmm27, xmm3, xmm19));
	INSTRUCTION_TEST(C5EB10CB                    , vmovsd(xmm1, xmm2, xmm3));
	INSTRUCTION_TEST(6261FF08104A7F              , vmovsd(xmm25, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(6261FF08108AF8FBFFFF        , vmovsd(xmm25, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(6261FF08104A80              , vmovsd(xmm25, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(6261FF081009                , vmovsd(xmm25, qword_ptr(rcx)));
	INSTRUCTION_TEST(6221FF08108CF023010000      , vmovsd(xmm25, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62C1970010EC                , vmovsd(xmm21, xmm29, xmm12));
	INSTRUCTION_TEST(6261FF08108A00040000        , vmovsd(xmm25, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(C5FB108C1A80000000          , vmovsd(xmm1, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(62E1FF08118A00040000        , vmovsd(qword_ptr(rdx, 1024), xmm17));
	INSTRUCTION_TEST(6261FF08114A7F              , vmovsd(qword_ptr(rdx, 1016), xmm25));
	INSTRUCTION_TEST(62E1FF08114A7F              , vmovsd(qword_ptr(rdx, 1016), xmm17));
	INSTRUCTION_TEST(6261FF08118AF8FBFFFF        , vmovsd(qword_ptr(rdx, -1032), xmm25));
	INSTRUCTION_TEST(62E1FF08118AF8FBFFFF        , vmovsd(qword_ptr(rdx, -1032), xmm17));
	INSTRUCTION_TEST(6261FF08114A80              , vmovsd(qword_ptr(rdx, -1024), xmm25));
	INSTRUCTION_TEST(62E1FF08114A80              , vmovsd(qword_ptr(rdx, -1024), xmm17));
	INSTRUCTION_TEST(6261FF081109                , vmovsd(qword_ptr(rcx), xmm25));
	INSTRUCTION_TEST(62E1FF081109                , vmovsd(qword_ptr(rcx), xmm17));
	INSTRUCTION_TEST(C5FB119C1180000000          , vmovsd(qword_ptr(rcx, rdx, 1, 128), xmm3));
	INSTRUCTION_TEST(62A1FF08118CF034120000      , vmovsd(qword_ptr(rax, r14, 8, 4660), xmm17));
	INSTRUCTION_TEST(6221FF08118CF023010000      , vmovsd(qword_ptr(rax, r14, 8, 291), xmm25));
	INSTRUCTION_TEST(C5FB10AA00040000            , vmovsd(xmm5, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(6261FF08118A00040000        , vmovsd(qword_ptr(rdx, 1024), xmm25));
	...
	INSTRUCTION_TEST(C5FA16CA                    , vmovshdup(xmm1, k0, xmm2));
	INSTRUCTION_TEST(62E17E481601                , vmovshdup(zmm16, k0, zmmword_ptr(rcx)));
	INSTRUCTION_TEST(C5FA168C1A80000000          , vmovshdup(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FE16CA                    , vmovshdup(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FE168C1A80000000          , vmovshdup(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C5FE128C1A80000000          , vmovsldup(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FE12CA                    , vmovsldup(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FA128C1A80000000          , vmovsldup(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FA12CA                    , vmovsldup(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(62C1260010D6                , vmovss(xmm18, xmm27, xmm14));
	...
	INSTRUCTION_TEST(C5F910CA                    , vmovupd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C5F9119C1180000000          , vmovupd(xmmword_ptr(rcx, rdx, 1, 128), k0, xmm3));
	INSTRUCTION_TEST(C5FD10CA                    , vmovupd(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FD108C1A80000000          , vmovupd(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FD119C1180000000          , vmovupd(ymmword_ptr(rcx, rdx, 1, 128), k0, ymm3));
	...
	INSTRUCTION_TEST(C5F9108C1A80000000          , vmovupd(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C5F810CA                    , vmovups(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C5F8108C1A80000000          , vmovups(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5F8119C1180000000          , vmovups(xmmword_ptr(rcx, rdx, 1, 128), k0, xmm3));
	INSTRUCTION_TEST(C5FC10CA                    , vmovups(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5FC108C1A80000000          , vmovups(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FC119C1180000000          , vmovups(ymmword_ptr(rcx, rdx, 1, 128), k0, ymm3));
	...
	INSTRUCTION_TEST(C5ED59CB                    , vmulpd(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C5ED598C2B80000000          , vmulpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9598C2B80000000          , vmulpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E959CB                    , vmulpd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EC598C2B80000000          , vmulps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F14C485919                , vmulps(zmm3, k0, zmm6, zmmword_ptr(rcx)));
	INSTRUCTION_TEST(C5E859CB                    , vmulps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E8598C2B80000000          , vmulps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC59CB                    , vmulps(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(62A1970059BCF034120000      , vmulsd(xmm23, xmm29, qword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62A1970059FE                , vmulsd(xmm23, xmm29, xmm22));
	INSTRUCTION_TEST(62E1970059BA00040000        , vmulsd(xmm23, xmm29, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62E19700597A7F              , vmulsd(xmm23, xmm29, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(62E1970059BAF8FBFFFF        , vmulsd(xmm23, xmm29, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(62E19700597A80              , vmulsd(xmm23, xmm29, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(62E197005939                , vmulsd(xmm23, xmm29, qword_ptr(rcx)));
	INSTRUCTION_TEST(6231DF0859EA                , vmulsd(xmm13, xmm4, xmm18));
	...
	INSTRUCTION_TEST(62212E00598CF034120000      , vmulss(xmm25, xmm26, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62612E00598A00020000        , vmulss(xmm25, xmm26, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62612E00594A7F              , vmulss(xmm25, xmm26, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62612E00598AFCFDFFFF        , vmulss(xmm25, xmm26, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62612E00594A80              , vmulss(xmm25, xmm26, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62412E0059C8                , vmulss(xmm25, xmm26, xmm8));
	INSTRUCTION_TEST(62C12E0859F6                , vmulss(xmm22, xmm10, xmm14));
	INSTRUCTION_TEST(62612E005909                , vmulss(xmm25, xmm26, dword_ptr(rcx)));
	INSTRUCTION_TEST(62E12E0859727F              , vmulss(xmm22, xmm10, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E12E0859B2FCFDFFFF        , vmulss(xmm22, xmm10, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E12E08597280              , vmulss(xmm22, xmm10, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E12E085931                , vmulss(xmm22, xmm10, dword_ptr(rcx)));
	INSTRUCTION_TEST(62A12E0859B4F023010000      , vmulss(xmm22, xmm10, dword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(62E12E0859B200020000        , vmulss(xmm22, xmm10, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C5E956CB                    , vorpd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9568C2B80000000          , vorpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED56CB                    , vorpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED568C2B80000000          , vorpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EC568C2B80000000          , vorps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E8568C2B80000000          , vorps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E856CB                    , vorps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EC56CB                    , vorps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2791CCA                  , vpabsb(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E2791C8C1A80000000        , vpabsb(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D1CCA                  , vpabsb(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C4E27D1C8C1A80000000        , vpabsb(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2791ECA                  , vpabsd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E2791E8C1A80000000        , vpabsd(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D1ECA                  , vpabsd(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C4E27D1E8C1A80000000        , vpabsd(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2791DCA                  , vpabsw(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E2791D8C1A80000000        , vpabsw(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D1DCA                  , vpabsw(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C4E27D1D8C1A80000000        , vpabsw(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C5ED6B8C2B80000000          , vpackssdw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E96B8C2B80000000          , vpackssdw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E96BCB                    , vpackssdw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5ED6BCB                    , vpackssdw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E963CB                    , vpacksswb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9638C2B80000000          , vpacksswb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED63CB                    , vpacksswb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED638C2B80000000          , vpacksswb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2692BCB                  , vpackusdw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2692B8C2B80000000        , vpackusdw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D2BCB                  , vpackusdw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26D2B8C2B80000000        , vpackusdw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5ED678C2B80000000          , vpackuswb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9678C2B80000000          , vpackuswb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E967CB                    , vpackuswb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5ED67CB                    , vpackuswb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(62F16D48FCCB                , vpaddb(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C5EDFC8C2B80000000          , vpaddb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D48FC4C2B02            , vpaddb(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9FC8C2B80000000          , vpaddb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9FCCB                    , vpaddb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDFCCB                    , vpaddb(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C5E9FECB                    , vpaddd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9FE8C2B80000000          , vpaddd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDFECB                    , vpaddd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDFE8C2B80000000          , vpaddd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDD48C2B80000000          , vpaddq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDD4CB                    , vpaddq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9D48C2B80000000          , vpaddq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9D4CB                    , vpaddq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EDEC8C2B80000000          , vpaddsb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDECCB                    , vpaddsb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9ECCB                    , vpaddsb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9EC8C2B80000000          , vpaddsb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9EDCB                    , vpaddsw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9ED8C2B80000000          , vpaddsw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDEDCB                    , vpaddsw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDED8C2B80000000          , vpaddsw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDDC8C2B80000000          , vpaddusb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9DCCB                    , vpaddusb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9DC8C2B80000000          , vpaddusb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDDCCB                    , vpaddusb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9DDCB                    , vpaddusw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9DD8C2B80000000          , vpaddusw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDDDCB                    , vpaddusw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDDD8C2B80000000          , vpaddusw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5E9FD8C2B80000000          , vpaddw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDFDCB                    , vpaddw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDFD8C2B80000000          , vpaddw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5E9FDCB                    , vpaddw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E36D0F8C2B8000000001      , vpalignr(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C4E36D0FCB01                , vpalignr(ymm1, k0, ymm2, ymm3, Imm(1)));
	INSTRUCTION_TEST(C4E3690FCB01                , vpalignr(xmm1, k0, xmm2, xmm3, Imm(1)));
	INSTRUCTION_TEST(C4E3690F8C2B8000000001      , vpalignr(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C5EDE08C2B80000000          , vpavgb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDE0CB                    , vpavgb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9E0CB                    , vpavgb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9E08C2B80000000          , vpavgb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9E3CB                    , vpavgw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9E38C2B80000000          , vpavgw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDE3CB                    , vpavgw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDE38C2B80000000          , vpavgw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D78CA                  , vpbroadcastb(ymm1, k0, xmm2));
	INSTRUCTION_TEST(62F27D087ACA                , vpbroadcastb(xmm1, k0, edx));
	INSTRUCTION_TEST(C4E27D788C1A80000000        , vpbroadcastb(ymm1, k0, byte_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27978CA                  , vpbroadcastb(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279788C1A80000000        , vpbroadcastb(xmm1, k0, byte_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27958CA                  , vpbroadcastd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D588C1A80000000        , vpbroadcastd(ymm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(62F27D287CCA                , vpbroadcastd(ymm1, k0, edx));
	INSTRUCTION_TEST(C4E27D58CA                  , vpbroadcastd(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279588C1A80000000        , vpbroadcastd(xmm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27959CA                  , vpbroadcastq(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D598C1A80000000        , vpbroadcastq(ymm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(62F2FD287CCA                , vpbroadcastq(ymm1, k0, rdx));
	INSTRUCTION_TEST(C4E279598C1A80000000        , vpbroadcastq(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D59CA                  , vpbroadcastq(ymm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C4E27D79CA                  , vpbroadcastw(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27979CA                  , vpbroadcastw(xmm1, k0, xmm2));
	INSTRUCTION_TEST(62F27D287BCA                , vpbroadcastw(ymm1, k0, edx));
	INSTRUCTION_TEST(C4E279798C1A80000000        , vpbroadcastw(xmm1, k0, word_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(62F27D087BCA                , vpbroadcastw(xmm1, k0, edx));
	INSTRUCTION_TEST(C4E27D798C1A80000000        , vpbroadcastw(ymm1, k0, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D368C2B80000000        , vpermd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D36CB                  , vpermd(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C4E37905CA01                , vpermilpd(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C4E2690DCB                  , vpermilpd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2690D8C2B80000000        , vpermilpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E379058C1A8000000001      , vpermilpd(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C4E37D05CA01                , vpermilpd(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(C4E26D0DCB                  , vpermilpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26D0D8C2B80000000        , vpermilpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E37D058C1A8000000001      , vpermilpd(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C4E37904CA01                , vpermilps(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(62B37D4804D6AB              , vpermilps(zmm2, k0, zmm22, Imm(171)));
	INSTRUCTION_TEST(C4E2690CCB                  , vpermilps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2690C8C2B80000000        , vpermilps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E379048C1A8000000001      , vpermilps(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C4E37D04CA01                , vpermilps(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(C4E26D0CCB                  , vpermilps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26D0C8C2B80000000        , vpermilps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E37D048C1A8000000001      , vpermilps(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C4E3FD01CA01                , vpermpd(ymm1, k0, ymm2, Imm(1)));
	...
	INSTRUCTION_TEST(C4E3FD018C1A8000000001      , vpermpd(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C4E26D168C2B80000000        , vpermps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D16CB                  , vpermps(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C4E3FD00CA01                , vpermq(ymm1, k0, ymm2, Imm(1)));
	...
	INSTRUCTION_TEST(C4E3FD008C1A8000000001      , vpermq(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	...
	INSTRUCTION_TEST(C4E26904CB                  , vpmaddubsw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E269048C2B80000000        , vpmaddubsw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D04CB                  , vpmaddubsw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26D048C2B80000000        , vpmaddubsw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5E9F5CB                    , vpmaddwd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9F58C2B80000000          , vpmaddwd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDF5CB                    , vpmaddwd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDF58C2B80000000          , vpmaddwd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E2693CCB                  , vpmaxsb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E2693C8C2B80000000        , vpmaxsb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D3CCB                  , vpmaxsb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E26D3C8C2B80000000        , vpmaxsb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D3D8C2B80000000        , vpmaxsd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D3DCB                  , vpmaxsd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2693D8C2B80000000        , vpmaxsd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2693DCB                  , vpmaxsd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EDEE8C2B80000000          , vpmaxsw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D48EE4C2B02            , vpmaxsw(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9EE8C2B80000000          , vpmaxsw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9EECB                    , vpmaxsw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDEECB                    , vpmaxsw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(62F16D48DECB                , vpmaxub(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C5EDDE8C2B80000000          , vpmaxub(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D48DE4C2B02            , vpmaxub(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9DE8C2B80000000          , vpmaxub(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9DECB                    , vpmaxub(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDDECB                    , vpmaxub(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C4E26D3F8C2B80000000        , vpmaxud(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D3FCB                  , vpmaxud(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2693F8C2B80000000        , vpmaxud(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2693FCB                  , vpmaxud(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D3E8C2B80000000        , vpmaxuw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F26D483E4C2B02            , vpmaxuw(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2693E8C2B80000000        , vpmaxuw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2693ECB                  , vpmaxuw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E26D3ECB                  , vpmaxuw(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C4E26D398C2B80000000        , vpminsd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D39CB                  , vpminsd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269398C2B80000000        , vpminsd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26939CB                  , vpminsd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EDEA8C2B80000000          , vpminsw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D48EA4C2B02            , vpminsw(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9EA8C2B80000000          , vpminsw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDEACB                    , vpminsw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9EACB                    , vpminsw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9DACB                    , vpminub(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9DA8C2B80000000          , vpminub(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDDACB                    , vpminub(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDDA8C2B80000000          , vpminub(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D3B8C2B80000000        , vpminud(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D3BCB                  , vpminud(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2693B8C2B80000000        , vpminud(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2693BCB                  , vpminud(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D3A8C2B80000000        , vpminuw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F26D483A4C2B02            , vpminuw(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2693A8C2B80000000        , vpminuw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2693ACB                  , vpminuw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E26D3ACB                  , vpminuw(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C4E27921CA                  , vpmovsxbd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D218C1A80000000        , vpmovsxbd(ymm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D21CA                  , vpmovsxbd(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279218C1A80000000        , vpmovsxbd(xmm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D22CA                  , vpmovsxbq(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D228C1A80000000        , vpmovsxbq(ymm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27922CA                  , vpmovsxbq(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279228C1A80000000        , vpmovsxbq(xmm1, k0, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D208C1A80000000        , vpmovsxbw(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D20CA                  , vpmovsxbw(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27920CA                  , vpmovsxbw(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279208C1A80000000        , vpmovsxbw(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D258C1A80000000        , vpmovsxdq(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D25CA                  , vpmovsxdq(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27925CA                  , vpmovsxdq(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279258C1A80000000        , vpmovsxdq(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27923CA                  , vpmovsxwd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D23CA                  , vpmovsxwd(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D238C1A80000000        , vpmovsxwd(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E279238C1A80000000        , vpmovsxwd(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E279248C1A80000000        , vpmovsxwq(xmm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D24CA                  , vpmovsxwq(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D248C1A80000000        , vpmovsxwq(ymm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27924CA                  , vpmovsxwq(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C4E279318C1A80000000        , vpmovzxbd(xmm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27931CA                  , vpmovzxbd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D318C1A80000000        , vpmovzxbd(ymm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D31CA                  , vpmovzxbd(ymm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C4E27D32CA                  , vpmovzxbq(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D328C1A80000000        , vpmovzxbq(ymm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27932CA                  , vpmovzxbq(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279328C1A80000000        , vpmovzxbq(xmm1, k0, word_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D308C1A80000000        , vpmovzxbw(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D30CA                  , vpmovzxbw(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279308C1A80000000        , vpmovzxbw(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27930CA                  , vpmovzxbw(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C4E279358C1A80000000        , vpmovzxdq(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27935CA                  , vpmovzxdq(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D35CA                  , vpmovzxdq(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D358C1A80000000        , vpmovzxdq(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27D338C1A80000000        , vpmovzxwd(ymm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C4E27D33CA                  , vpmovzxwd(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27933CA                  , vpmovzxwd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C4E279338C1A80000000        , vpmovzxwd(xmm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E27934CA                  , vpmovzxwq(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C4E27D34CA                  , vpmovzxwq(ymm1, k0, xmm2));
	INSTRUCTION_TEST(C4E27D348C1A80000000        , vpmovzxwq(ymm1, k0, qword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(62727D4834A2F0F7FFFF        , vpmovzxwq(zmm12, k0, xmmword_ptr(rdx, -2064)));
	INSTRUCTION_TEST(C4E279348C1A80000000        , vpmovzxwq(xmm1, k0, dword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D288C2B80000000        , vpmuldq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D28CB                  , vpmuldq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269288C2B80000000        , vpmuldq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26928CB                  , vpmuldq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D0B8C2B80000000        , vpmulhrsw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F26D480B4C2B02            , vpmulhrsw(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2690B8C2B80000000        , vpmulhrsw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2690BCB                  , vpmulhrsw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C4E26D0BCB                  , vpmulhrsw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9E4CB                    , vpmulhuw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9E48C2B80000000          , vpmulhuw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDE4CB                    , vpmulhuw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDE48C2B80000000          , vpmulhuw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDE58C2B80000000          , vpmulhw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9E58C2B80000000          , vpmulhw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9E5CB                    , vpmulhw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDE5CB                    , vpmulhw(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C4E26D408C2B80000000        , vpmulld(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D40CB                  , vpmulld(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269408C2B80000000        , vpmulld(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26940CB                  , vpmulld(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5E9D5CB                    , vpmullw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9D58C2B80000000          , vpmullw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDD5CB                    , vpmullw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDD58C2B80000000          , vpmullw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDF48C2B80000000          , vpmuludq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDF4CB                    , vpmuludq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9F48C2B80000000          , vpmuludq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9F4CB                    , vpmuludq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D008C2B80000000        , vpshufb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D00CB                  , vpshufb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269008C2B80000000        , vpshufb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26900CB                  , vpshufb(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5FD708C1A8000000001        , vpshufd(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5FD70CA01                  , vpshufd(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(C5F9708C1A8000000001        , vpshufd(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5F970CA01                  , vpshufd(xmm1, k0, xmm2, Imm(1)));
	...
	INSTRUCTION_TEST(C5FE708C1A8000000001        , vpshufhw(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5FA70CA01                  , vpshufhw(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5FA708C1A8000000001        , vpshufhw(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5FE70CA01                  , vpshufhw(ymm1, k0, ymm2, Imm(1)));
	...
	INSTRUCTION_TEST(C5FF708C1A8000000001        , vpshuflw(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5FB70CA01                  , vpshuflw(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5FB708C1A8000000001        , vpshuflw(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5FF70CA01                  , vpshuflw(ymm1, k0, ymm2, Imm(1)));
	...
	INSTRUCTION_TEST(C5F172F201                  , vpslld(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5E9F2CB                    , vpslld(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9F28C2B80000000          , vpslld(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1750872741A0801          , vpslld(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5F572F201                  , vpslld(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(C5EDF2CB                    , vpslld(ymm1, k0, ymm2, xmm3));
	INSTRUCTION_TEST(C5EDF28C2B80000000          , vpslld(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5F173F201                  , vpsllq(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5E9F3CB                    , vpsllq(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9F38C2B80000000          , vpsllq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1F50873741A0801          , vpsllq(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5F573F201                  , vpsllq(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(6221ED48F3ACF034120000      , vpsllq(zmm29, k0, zmm2, xmmword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(C5EDF38C2B80000000          , vpsllq(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDF3CB                    , vpsllq(ymm1, k0, ymm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D478C2B80000000        , vpsllvd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D47CB                  , vpsllvd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269478C2B80000000        , vpsllvd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26947CB                  , vpsllvd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2ED478C2B80000000        , vpsllvq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED47CB                  , vpsllvq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9478C2B80000000        , vpsllvq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E947CB                  , vpsllvq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EDF18C2B80000000          , vpsllw(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1754871F201              , vpsllw(zmm1, k0, zmm2, Imm(1)));
	INSTRUCTION_TEST(C5F571F201                  , vpsllw(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(62F1750871741A0801          , vpsllw(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5E9F18C2B80000000          , vpsllw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9F1CB                    , vpsllw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5F171F201                  , vpsllw(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5EDF1CB                    , vpsllw(ymm1, k0, ymm2, xmm3));
	...
	INSTRUCTION_TEST(C5F172E201                  , vpsrad(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5E9E2CB                    , vpsrad(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9E28C2B80000000          , vpsrad(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1750872641A0801          , vpsrad(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5F572E201                  , vpsrad(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(C5EDE28C2B80000000          , vpsrad(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDE2CB                    , vpsrad(ymm1, k0, ymm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D468C2B80000000        , vpsravd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C4E26D46CB                  , vpsravd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269468C2B80000000        , vpsravd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26946CB                  , vpsravd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EDE18C2B80000000          , vpsraw(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1754871E201              , vpsraw(zmm1, k0, zmm2, Imm(1)));
	INSTRUCTION_TEST(C5F571E201                  , vpsraw(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(62F1750871641A0801          , vpsraw(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5E9E18C2B80000000          , vpsraw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9E1CB                    , vpsraw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5F171E201                  , vpsraw(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5EDE1CB                    , vpsraw(ymm1, k0, ymm2, xmm3));
	...
	INSTRUCTION_TEST(C5F172D201                  , vpsrld(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5E9D2CB                    , vpsrld(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9D28C2B80000000          , vpsrld(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1750872541A0801          , vpsrld(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5F572D201                  , vpsrld(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(C5EDD2CB                    , vpsrld(ymm1, k0, ymm2, xmm3));
	INSTRUCTION_TEST(C5EDD28C2B80000000          , vpsrld(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5F173D201                  , vpsrlq(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5E9D3CB                    , vpsrlq(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9D38C2B80000000          , vpsrlq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F1F50873541A0801          , vpsrlq(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5F573D201                  , vpsrlq(ymm1, k0, ymm2, Imm(1)));
	INSTRUCTION_TEST(C5EDD38C2B80000000          , vpsrlq(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDD3CB                    , vpsrlq(ymm1, k0, ymm2, xmm3));
	...
	INSTRUCTION_TEST(C4E26D458C2B80000000        , vpsrlvd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26D45CB                  , vpsrlvd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E269458C2B80000000        , vpsrlvd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E26945CB                  , vpsrlvd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C4E2ED458C2B80000000        , vpsrlvq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2ED45CB                  , vpsrlvq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C4E2E9458C2B80000000        , vpsrlvq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C4E2E945CB                  , vpsrlvq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EDD18C2B80000000          , vpsrlw(ymm1, k0, ymm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDD1CB                    , vpsrlw(ymm1, k0, ymm2, xmm3));
	INSTRUCTION_TEST(62F1750871541A0801          , vpsrlw(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5E9D18C2B80000000          , vpsrlw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9D1CB                    , vpsrlw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5F171D201                  , vpsrlw(xmm1, k0, xmm2, Imm(1)));
	INSTRUCTION_TEST(C5F571D201                  , vpsrlw(ymm1, k0, ymm2, Imm(1)));
	...
	INSTRUCTION_TEST(C5EDF88C2B80000000          , vpsubb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9F88C2B80000000          , vpsubb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9F8CB                    , vpsubb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDF8CB                    , vpsubb(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C5EDFA8C2B80000000          , vpsubd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDFACB                    , vpsubd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9FA8C2B80000000          , vpsubd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9FACB                    , vpsubd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5E9FBCB                    , vpsubq(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDFBCB                    , vpsubq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDFB8C2B80000000          , vpsubq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62E1BD48FB4280              , vpsubq(zmm16, k0, zmm8, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(C5E9FB8C2B80000000          , vpsubq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5E9E8CB                    , vpsubsb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9E88C2B80000000          , vpsubsb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDE8CB                    , vpsubsb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDE88C2B80000000          , vpsubsb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDE98C2B80000000          , vpsubsw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D48E94C2B02            , vpsubsw(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9E98C2B80000000          , vpsubsw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9E9CB                    , vpsubsw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDE9CB                    , vpsubsw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9D8CB                    , vpsubusb(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9D88C2B80000000          , vpsubusb(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDD8CB                    , vpsubusb(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDD88C2B80000000          , vpsubusb(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EDD98C2B80000000          , vpsubusw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9D98C2B80000000          , vpsubusw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9D9CB                    , vpsubusw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EDD9CB                    , vpsubusw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E9F9CB                    , vpsubw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9F98C2B80000000          , vpsubw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EDF9CB                    , vpsubw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EDF98C2B80000000          , vpsubw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5E968CB                    , vpunpckhbw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9688C2B80000000          , vpunpckhbw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED68CB                    , vpunpckhbw(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED688C2B80000000          , vpunpckhbw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5ED6A8C2B80000000          , vpunpckhdq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED6ACB                    , vpunpckhdq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E96A8C2B80000000          , vpunpckhdq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E96ACB                    , vpunpckhdq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5ED6D8C2B80000000          , vpunpckhqdq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED6DCB                    , vpunpckhqdq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E96D8C2B80000000          , vpunpckhqdq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(626185486D5A80              , vpunpckhqdq(zmm27, k0, zmm15, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(C5E96DCB                    , vpunpckhqdq(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(62F16D4869CB                , vpunpckhwd(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C5ED698C2B80000000          , vpunpckhwd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D48694C2B02            , vpunpckhwd(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9698C2B80000000          , vpunpckhwd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E969CB                    , vpunpckhwd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5ED69CB                    , vpunpckhwd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(62F16D4860CB                , vpunpcklbw(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C5ED608C2B80000000          , vpunpcklbw(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D48604C2B02            , vpunpcklbw(zmm1, k0, zmm2, zmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E9608C2B80000000          , vpunpcklbw(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E960CB                    , vpunpcklbw(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5ED60CB                    , vpunpcklbw(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C5E9628C2B80000000          , vpunpckldq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED62CB                    , vpunpckldq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED628C2B80000000          , vpunpckldq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E962CB                    , vpunpckldq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5ED6C8C2B80000000          , vpunpcklqdq(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED6CCB                    , vpunpcklqdq(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E96C8C2B80000000          , vpunpcklqdq(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E96CCB                    , vpunpcklqdq(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5ED618C2B80000000          , vpunpcklwd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16D4861CB                , vpunpcklwd(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C5E9618C2B80000000          , vpunpcklwd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E961CB                    , vpunpcklwd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5ED61CB                    , vpunpcklwd(ymm1, k0, ymm2, ymm3));
	...
	INSTRUCTION_TEST(C5EDC68C2B8000000001        , vshufpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5EDC6CB01                  , vshufpd(ymm1, k0, ymm2, ymm3, Imm(1)));
	INSTRUCTION_TEST(C5E9C68C2B8000000001        , vshufpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5E9C6CB01                  , vshufpd(xmm1, k0, xmm2, xmm3, Imm(1)));
	...
	INSTRUCTION_TEST(C5E8C68C2B8000000001        , vshufps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	INSTRUCTION_TEST(C5ECC6CB01                  , vshufps(ymm1, k0, ymm2, ymm3, Imm(1)));
	INSTRUCTION_TEST(C5ECC68C2B8000000001        , vshufps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128), Imm(1)));
	INSTRUCTION_TEST(62917448C6C97B              , vshufps(zmm1, k0, zmm1, zmm25, Imm(123)));
	INSTRUCTION_TEST(C5E8C6CB01                  , vshufps(xmm1, k0, xmm2, xmm3, Imm(1)));
	...
	INSTRUCTION_TEST(C5F951CA                    , vsqrtpd(xmm1, k0, xmm2));
	INSTRUCTION_TEST(C5F9518C1A80000000          , vsqrtpd(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FD51CA                    , vsqrtpd(ymm1, k0, ymm2));
	...
	INSTRUCTION_TEST(C5FD518C1A80000000          , vsqrtpd(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	...
	INSTRUCTION_TEST(C5FC518C1A80000000          , vsqrtps(ymm1, k0, ymmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5FC51CA                    , vsqrtps(ymm1, k0, ymm2));
	INSTRUCTION_TEST(C5F8518C1A80000000          , vsqrtps(xmm1, k0, xmmword_ptr(rdx, rbx, 1, 128)));
	INSTRUCTION_TEST(C5F851CA                    , vsqrtps(xmm1, k0, xmm2));
	...
	INSTRUCTION_TEST(C4C16B51F4                  , vsqrtsd(xmm6, k0, xmm2, xmm12));
	INSTRUCTION_TEST(C5EB51B200FCFFFF            , vsqrtsd(xmm6, k0, xmm2, qword_ptr(rdx, -1024)));
	INSTRUCTION_TEST(C5EB51B2F8030000            , vsqrtsd(xmm6, k0, xmm2, qword_ptr(rdx, 1016)));
	INSTRUCTION_TEST(C5EB51B2F8FBFFFF            , vsqrtsd(xmm6, k0, xmm2, qword_ptr(rdx, -1032)));
	INSTRUCTION_TEST(C5EB5131                    , vsqrtsd(xmm6, k0, xmm2, qword_ptr(rcx)));
	INSTRUCTION_TEST(C4A16B51B4F023010000        , vsqrtsd(xmm6, k0, xmm2, qword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(C5EB51CB                    , vsqrtsd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EB518C2B80000000          , vsqrtsd(xmm1, k0, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EB51B200040000            , vsqrtsd(xmm6, k0, xmm2, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62410E0851CB                , vsqrtss(xmm25, xmm14, xmm11));
	INSTRUCTION_TEST(62610E08518A00020000        , vsqrtss(xmm25, xmm14, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62610E08514A7F              , vsqrtss(xmm25, xmm14, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62610E08518AFCFDFFFF        , vsqrtss(xmm25, xmm14, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62610E08514A80              , vsqrtss(xmm25, xmm14, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62610E085109                , vsqrtss(xmm25, xmm14, dword_ptr(rcx)));
	INSTRUCTION_TEST(62C1660051F0                , vsqrtss(xmm22, xmm19, xmm8));
	INSTRUCTION_TEST(62210E08518CF034120000      , vsqrtss(xmm25, xmm14, dword_ptr(rax, r14, 8, 4660)));
	INSTRUCTION_TEST(62E1660051727F              , vsqrtss(xmm22, xmm19, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62E1660051B200020000        , vsqrtss(xmm22, xmm19, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62E1660051B2FCFDFFFF        , vsqrtss(xmm22, xmm19, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62E16600517280              , vsqrtss(xmm22, xmm19, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62E166005131                , vsqrtss(xmm22, xmm19, dword_ptr(rcx)));
	INSTRUCTION_TEST(62A1660051B4F023010000      , vsqrtss(xmm22, xmm19, dword_ptr(rax, r14, 8, 291)));
	...
	INSTRUCTION_TEST(C5E95C8C2B80000000          , vsubpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED5CCB                    , vsubpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED5C8C2B80000000          , vsubpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E95CCB                    , vsubpd(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EC5C8C2B80000000          , vsubps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC5CCB                    , vsubps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E85C8C2B80000000          , vsubps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E85CCB                    , vsubps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EB5CCB                    , vsubsd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5EB5C8C2B80000000          , vsubsd(xmm1, k0, xmm2, qword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62E1A7005CA200040000        , vsubsd(xmm20, k0, xmm27, qword_ptr(rdx, 1024)));
	INSTRUCTION_TEST(62F136005C6A80              , vsubss(xmm5, xmm25, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62D136005CE9                , vsubss(xmm5, xmm25, xmm9));
	INSTRUCTION_TEST(62F136005CAA00020000        , vsubss(xmm5, xmm25, dword_ptr(rdx, 512)));
	INSTRUCTION_TEST(62F136005C6A7F              , vsubss(xmm5, xmm25, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62F136005CAAFCFDFFFF        , vsubss(xmm5, xmm25, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62F136005C29                , vsubss(xmm5, xmm25, dword_ptr(rcx)));
	INSTRUCTION_TEST(62B136005CACF023010000      , vsubss(xmm5, xmm25, dword_ptr(rax, r14, 8, 291)));
	INSTRUCTION_TEST(62215E005CD8                , vsubss(xmm27, xmm20, xmm16));
	INSTRUCTION_TEST(62615E005C5A7F              , vsubss(xmm27, xmm20, dword_ptr(rdx, 508)));
	INSTRUCTION_TEST(62615E005C9AFCFDFFFF        , vsubss(xmm27, xmm20, dword_ptr(rdx, -516)));
	INSTRUCTION_TEST(62615E005C5A80              , vsubss(xmm27, xmm20, dword_ptr(rdx, -512)));
	INSTRUCTION_TEST(62615E005C19                , vsubss(xmm27, xmm20, dword_ptr(rcx)));
	INSTRUCTION_TEST(62215E005C9CF034120000      , vsubss(xmm27, xmm20, dword_ptr(rax, r14, 8, 4660)));
	...
	INSTRUCTION_TEST(62615E005C9A00020000        , vsubss(xmm27, xmm20, dword_ptr(rdx, 512)));
	...
	INSTRUCTION_TEST(C5E915CB                    , vunpckhpd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9158C2B80000000          , vunpckhpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED15CB                    , vunpckhpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED158C2B80000000          , vunpckhpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5E8158C2B80000000          , vunpckhps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC15CB                    , vunpckhps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5EC158C2B80000000          , vunpckhps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5E815CB                    , vunpckhps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5E914CB                    , vunpcklpd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9148C2B80000000          , vunpcklpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED14CB                    , vunpcklpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED148C2B80000000          , vunpcklpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5E814CB                    , vunpcklps(xmm1, k0, xmm2, xmm3));
	...
	INSTRUCTION_TEST(C5EC148C2B80000000          , vunpcklps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC14CB                    , vunpcklps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5E8148C2B80000000          , vunpcklps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(62F16448144A80              , vunpcklps(zmm1, k0, zmm3, zmmword_ptr(rdx, -8192)));
	INSTRUCTION_TEST(C5E957CB                    , vxorpd(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E9578C2B80000000          , vxorpd(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5ED57CB                    , vxorpd(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(C5ED578C2B80000000          , vxorpd(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(C5EC578C2B80000000          , vxorps(ymm1, k0, ymm2, ymmword_ptr(rbx, rbp, 1, 128)));
	INSTRUCTION_TEST(C5EC57CB                    , vxorps(ymm1, k0, ymm2, ymm3));
	INSTRUCTION_TEST(62F16C4857CB                , vxorps(zmm1, k0, zmm2, zmm3));
	INSTRUCTION_TEST(C5E857CB                    , vxorps(xmm1, k0, xmm2, xmm3));
	INSTRUCTION_TEST(C5E8578C2B80000000          , vxorps(xmm1, k0, xmm2, xmmword_ptr(rbx, rbp, 1, 128)));
	...
	INSTRUCTION_TEST(87C0                        , xchg(eax, eax));
	...
	INSTRUCTION_TEST(6690                        , xchg(ax, ax));
